...
Magnify.prototype = {
  ...
  render: function() {
    var btnsTpl = {
      minimize:
        '<button title="最小化"  class="magnify-button magnify-button-minimize" title="' +
        this.options.i18n.minimize +
        '">' +
        this.options.icons.minimize +
        '</button>',
      maximize:
        '<button title="最大化" class="magnify-button magnify-button-maximize" title="' +
        this.options.i18n.maximize +
        '">' +
        this.options.icons.maximize +
        '</button>',
      close:
        '<button title="关闭" class="magnify-button magnify-button-close" title="' +
        this.options.i18n.close +
        '">' +
        this.options.icons.close +
        '</button>',
      zoomIn:
        '<button title="放大" class="magnify-button magnify-button-zoom-in" title="' +
        this.options.i18n.zoomIn +
        '">' +
        this.options.icons.zoomIn +
        '</button>',
      zoomOut:
        '<button title="缩小" class="magnify-button magnify-button-zoom-out" title="' +
        this.options.i18n.zoomOut +
        '">' +
        this.options.icons.zoomOut +
        '</button>',
      prev:
        '<button title="上一张" class="magnify-button magnify-button-prev" title="' +
        this.options.i18n.prev +
        '">' +
        this.options.icons.prev +
        '</button>',
      next:
        '<button title="下一张" class="magnify-button magnify-button-next" title="' +
        this.options.i18n.next +
        '">' +
        this.options.icons.next +
        '</button>',
      fullscreen:
        '<button title="全屏" class="magnify-button magnify-button-fullscreen" title="' +
        this.options.i18n.fullscreen +
        '">' +
        this.options.icons.fullscreen +
        '</button>',
      actualSize:
        '<button title="正常" class="magnify-button magnify-button-actual-size" title="' +
        this.options.i18n.actualSize +
        '">' +
        this.options.icons.actualSize +
        '</button>',
      rotateLeft:
        '<button title="左旋转" class="magnify-button magnify-button-rotate-left" title="' +
        this.options.i18n.rotateLeft +
        '">' +
        this.options.icons.rotateLeft +
        '</button>',
      rotateRight:
        '<button title="右旋转" class="magnify-button magnify-button-rotate-right" title="' +
